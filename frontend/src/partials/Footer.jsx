    ...
    <footer className="text-gray-500 text-xs mx-10">
      <div className="flex flex-col items-center sm:flex-row sm:items-center mx-10">
        ...
        <div className="flex flex-col items-center sm:flex-row sm:ml-auto">
          <Link to={`/home/${user_id}`} className="sm:ml-0 sm:mr-8">News</Link>
          <Link to={`/about/${user_id}`} className="sm:ml-0 sm:mr-8">About</Link>
          <Link to={`/contacts/${user_id}`} className="sm:ml-0 sm:mr-8">Contact</Link>
          <Link to={`/faqs/${user_id}`} className="sm:ml-0 sm:mr-8">FAQs</Link>
