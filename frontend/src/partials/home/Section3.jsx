...
import Image from '../../images/resources/welcome_07.png';
    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-6 bg-white dark:bg-[#181818] shadow-md rounded-sm">
      <div className="md:flex-1 px-5 py-4 md:flex">
        ...
        <div className='pt-5 pr-5'>
          <h2 className="font-semibold text-slate-800 dark:text-slate-100 mb-1">Community Tax Certificate (CTC) or Cedula</h2>
