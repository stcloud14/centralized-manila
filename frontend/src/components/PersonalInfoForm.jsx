...
const PersonalInfoForm =()=>{
  ...
  const togglePopover1 = () => {
    setPopoverVisible1(!popoverVisible1);
  };
  ...
  return (
    <div className="flex h-screen overflow-hidden dark:bg-[#212121]">
          ...
          <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-[#2b2b2b] dark:border-[#3d3d3d] shadow-lg rounded-sm border border-slate-200 mx-4 my-4">
            ...
            <div className="grid grid-cols-5 items-center">
              <div className="hidden sm:flex mb-7">
                ...
                <h1 className="text-[0.45rem] flex text-gray-500 dark:text-gray-400 pl-1">Update your personal details by completing the form below. <br/>Ensure accuracy in your personal information to <br/>maintain up-to-date records.</h1>
              </div>
      ...
      {popoverVisible1 && (
        <div className="absolute z-10 inline-block text-sm text-gray-500 transition-opacity bg-white border border-gray-200 rounded-lg shadow-sm w-72">
