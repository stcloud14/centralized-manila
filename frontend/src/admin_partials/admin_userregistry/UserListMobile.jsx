              ...
              <div className="bg-white dark:bg-[#333333] shadow-md rounded-sm mb-4">
                ...
                <div className="px-4 py-5">
                  ...
                  <div className="mt-5 flex space-x-3 justify-center">
                    <div className="flex group justify-center items-center text-center px-2 py-1 border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white rounded-full mt-2">
                    ...
                    <div className="flex justify-center items-center text-center px-2 py-1 border border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-white rounded-full mt-2">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-0.5">
                        <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                      </svg>
                      <span className="text-xs font-normal">&nbsp;Edit</span>
                    </div>
                    <div className="flex justify-center items-center text-center px-2 py-1 border border-red-500 text-red-500 hover:bg-red-500 hover:text-white rounded-full mt-2">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-0.5">
