    ...
    try {
      ...
      const secondTableData = [
        ...
        pdf.autoTable({
          ...
          const formattedTotalGrossRevenue = new Intl.NumberFormat('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 }).format(RevenueData.totalCC);
        ...
        pdf.setFont("helvetica", "normal");
         ...
         const signatureData2 = [['Community Tax Certificate Admin']];
         pdf.autoTable({
             startY: pdf.autoTable.previous.finalY - 16,
             head: [['Community Tax Certificate Administrative']],
             body: signatureData2,
             theme: 'plain',
             styles: {
                 cellPadding: 2,
         ...
         const fullName = "Community Tax Certificate Administrative";
...
export default AdminDashCTCForm;