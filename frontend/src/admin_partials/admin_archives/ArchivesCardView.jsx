...
const ArchivesCardView = ({ filteredTaxClearance, filteredTaxPayment, filteredBusinessPermit, filteredctcCedula, filteredBirthCert, filteredDeathCert, filteredMarriageCert, handleModalOpen, section }) => {
  return (
