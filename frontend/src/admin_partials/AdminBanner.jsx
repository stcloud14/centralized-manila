  ...
  return (
    <div className="relative px-2 sm:px-2 overflow-hidden mb-4">
      ...
      <div className="relative flex items-center justify-between">
        ...
        {/* <button  onClick={() => generateReports(selectedDate, selectedDatee)} className="border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white md:text-xs text-[0.60rem] py-1 px-4 sm:py-2 ml-2 sm:ml-[13.4rem] sm:mt-2 justify-center group w-auto items-center flex text-center rounded-sm">
        ...
        <div className="flex flex-col items-center">
          <div className="flex w-full items-center justify-end mb-1 sm:mb-0">
            <span className="hidden sm:block text-xs mr-2">Year:</span>
              <select value="" onChange={handleOptionChange} className="bg-white dark:bg-[#2b2b2b] text-xs border border-slate-300 text-slate-700 dark:text-white py-1 md:py-0.5 rounded-sm w-full sm:w-[150px]">
                <option className="dark:bg-[#3d3d3d]" value="">Select Year</option>
                <option className="dark:bg-[#3d3d3d]" value="1">2000</option>
                <option className="dark:bg-[#3d3d3d]" value="2">2001</option>
                <option className="dark:bg-[#3d3d3d]" value="3">2002</option>
                <option className="dark:bg-[#3d3d3d]" value="4">2003</option>
                <option className="dark:bg-[#3d3d3d]" value="5">2004</option>
                <option className="dark:bg-[#3d3d3d]" value="6">2005</option>
                <option className="dark:bg-[#3d3d3d]" value="7">2006</option>
                <option className="dark:bg-[#3d3d3d]" value="8">2007</option>
                <option className="dark:bg-[#3d3d3d]" value="9">2008</option>
                <option className="dark:bg-[#3d3d3d]" value="10">2009</option>
                <option className="dark:bg-[#3d3d3d]" value="11">2010</option>
                <option className="dark:bg-[#3d3d3d]" value="12">2011</option>
              </select>
            {/* <Flatpickr
              value={selectedDate}
          ...
          <div className="flex w-full items-center">
              ...
              <button  onClick={() => generateReports(selectedDate, selectedDatee)} className="border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white md:text-xs text-[0.60rem] py-0 sm:py-2 ml-2 px-2 sm:ml-[13.4rem] sm:mt-2 justify-center group w-full sm:w-[14.2rem] items-center flex text-center rounded-sm">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 mr-2 flex-shrink-0">
                <path fillRule="evenodd" d="M7.875 1.5C6.839 1.5 6 2.34 6 3.375v2.99c-.426.053-.851.11-1.274.174-1.454.218-2.476 1.483-2.476 2.917v6.294a3 3 0 0 0 3 3h.27l-.155 1.705A1.875 1.875 0 0 0 7.232 22.5h9.536a1.875 1.875 0 0 0 1.867-2.045l-.155-1.705h.27a3 3 0 0 0 3-3V9.456c0-1.434-1.022-2.7-2.476-2.917A48.716 48.716 0 0 0 18 6.366V3.375c0-1.036-.84-1.875-1.875-1.875h-8.25ZM16.5 6.205v-2.83A.375.375 0 0 0 16.125 3h-8.25a.375.375 0 0 0-.375.375v2.83a49.353 49.353 0 0 1 9 0Zm-.217 8.265c.178.018.317.16.333.337l.526 5.784a.375.375 0 0 1-.374.409H7.232a.375.375 0 0 1-.374-.409l.526-5.784a.373.373 0 0 1 .333-.337 41.741 41.741 0 0 1 8.566 0Zm.967-3.97a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75H18a.75.75 0 0 1-.75-.75V10.5ZM15 9.75a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75V10.5a.75.75 0 0 0-.75-.75H15Z" clipRule="evenodd" />
              </svg>
              Generate Reports
