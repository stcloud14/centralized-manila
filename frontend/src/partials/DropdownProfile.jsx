  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        ...
        />
        <svg xmlns="http://www.w3.org/2000/svg" className="w-[30px] h-[30px] pb-3 text-blue-400 absolute bottom-0 right-[3.8rem] z-10 transform translate-x-1/2 translate-y-1/2" viewBox="0 0 841.89 595.28">
