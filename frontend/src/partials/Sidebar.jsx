            ...
            <ul className="submenu mt-3 text-slate-700 hover:text-blue-600 dark:text-white dark:hover:text-blue-600">
                        ...
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to={`/marriagecertificate/${user_id}`}
                              className={({ isActive }) =>
                                'block transition duration-150 truncate ' + (isActive ? 'text-emerald-500' : 'text-slate-400 hover:text-blue-500')
                              }
                            >
             ...
             <li className="px-3 py-2 rounded-sm mb-0.5 last:mb-0">
                <NavLink
                  ...
                  <div className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="shrink-0 w-6 h-6">
                      <path className='fill-slate-400' d="M19.5 6h-15v9h15V6Z" />
                      <path className='fill-slate-500' fillRule="evenodd" d="M3.375 3C2.339 3 1.5 3.84 1.5 4.875v11.25C1.5 17.16 2.34 18 3.375 18H9.75v1.5H6A.75.75 0 0 0 6 21h12a.75.75 0 0 0 0-1.5h-3.75V18h6.375c1.035 0 1.875-.84 1.875-1.875V4.875C22.5 3.839 21.66 3 20.625 3H3.375Zm0 13.5h17.25a.375.375 0 0 0 .375-.375V4.875a.375.375 0 0 0-.375-.375H3.375A.375.375 0 0 0 3 4.875v11.25c0 .207.168.375.375.375Z" clipRule="evenodd" />
                    </svg>
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                      News
                    </span>
