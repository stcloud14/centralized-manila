...
const RPCardView = ({ filteredTaxClearance, filteredTaxPayment, handleModalOpen, handleChargeOpen, handleRejectConfirm, handleProcessConfirm, handleCompleteConfirm, section }) => {
  return (
