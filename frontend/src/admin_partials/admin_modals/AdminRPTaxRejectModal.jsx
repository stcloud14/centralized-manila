...
const AdminRPTaxRejectModal = ({ isOpen3, handleClose3, handleReject }) => {
  return (
    isOpen3 && (
                ...
                <div className="bg-white dark:bg-[#212121] px-4 pt-3 pb-5 gap-3 sm:px-6 flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-5 mt-auto">
                      ...
                      <button
                        ...
                        type="button"
                        className="text-white text-xs md:text-sm bg-red-500 border border-red-500 hover:bg-red-600 hover:border-red-600 font-normal rounded-sm px-5 py-2 text-center dark:border-red-500 dark:text-white dark:hover:text-white dark:hover:bg-red-700 dark:hover:border-red-700 flex items-center space-x-1"
                      >
...
export default AdminRPTaxRejectModal;
