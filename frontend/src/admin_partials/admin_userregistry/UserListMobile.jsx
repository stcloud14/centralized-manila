...
const UserListMobile = ({handleOpenModal, handleOpenModal2, handleOpenModal3}) => {
              ...
              <div className="bg-white dark:bg-[#333333] shadow-md rounded-sm mb-4">
                ...
                <div className="px-4 py-5">
                  ...
                  <div className="mt-5 flex space-x-3 justify-center">
                    ...
                    <div onClick={handleOpenModal2} className="flex justify-center items-center text-center px-2 py-1 border border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-white rounded-sm mt-2">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-0.5">
