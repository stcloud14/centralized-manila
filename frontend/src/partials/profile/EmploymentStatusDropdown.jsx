    ...
    const EmploymentStatusDropdown = () => {
        return (
            <>
                    ...
                    <option value="EMPLOYEE FULLTIME" className='dark:bg-[#3d3d3d]'>Employed - Full Time</option>
                    <option value="EMPLOYEE PARTTIME" className='dark:bg-[#3d3d3d]'>Employed - Part Time</option>
