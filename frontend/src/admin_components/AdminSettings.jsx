            ...
            <div className="px-5 py-5">
                <form className="max-w-md mx-auto">
                  ...
                  <div className="grid gap-6">
                    ...
                    <div className="flex items-center justify-center w-full bg-slate-200 rounded-full py-2 text-center mb-2">
                      
                      <h1 className="font-medium text-sm text-slate-700 ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6 mr-2 inline-block text-slate-700 ">
                        ...
                        Contact the System Admin to Change Your Password.
                      </h1>
                    </div>
