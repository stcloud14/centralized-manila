      ...
      const secondTableData = [
        ...
        pdf.autoTable({
          ...
          const noteText = [
            ...
            `financial and operational performance of Business Permit Transactions as of ${selectedYear}. Any identified`,
        ...
        pdf.setFont("helvetica", "normal");
         ...
         const signatureData2 = [['Business Permit Admin']];
         pdf.autoTable({
             startY: pdf.autoTable.previous.finalY - 16,
             head: [['Business Permit Administrative']],
             body: signatureData2,
             theme: 'plain',
             styles: {
                 cellPadding: 2,
         ...
         const fullName = "Business Permit Administrative";
