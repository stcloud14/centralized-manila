...
function AdminBanner({ adminType, generateReports}) {
  ...
  <button onClick={generateReports} className="border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white md:text-xs text-[0.60rem] py-2 px-4 sm:ml-10 w-auto rounded-sm flex items-center">
