...
const AdminRPTaxPaymentModal = ({ isOpen2, handleClose2, handleProcess2 }) => {
  return (
    isOpen2 && (
                      ...
                      <div className="mx-auto">
                        ...
                        <div className="mb-6">
                          ...
                          <div className="flex flex-col sm:flex-row items-start justify-between mb-1">
                            ...
                            <span className="whitespace-nowrap md:mb-0 mb-1">Tax Payment</span>
                          </div>
                          <div className="flex flex-col sm:flex-row items-start justify-between mb-1">
                            <span className="font-medium whitespace-nowrap">Account Name</span>
                            <span className="whitespace-nowrap md:mb-0 mb-1">Paolo Maghirang</span>
                          </div>
                          <div className="flex flex-col sm:flex-row items-start justify-between mb-1">
...
export default AdminRPTaxPaymentModal;
