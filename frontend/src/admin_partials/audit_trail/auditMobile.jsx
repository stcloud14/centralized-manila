        ...
        <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-[#2b2b2b] dark:border-[#3d3d3d] shadow-lg rounded-sm border border-slate-200">
              <div className="px-5 py-5">
                ...
                <div className="flex justify-center items-center mb-0 md:px-0 md:pr-0.5 px-0.5 text-xs">
                  ...
                  <button onClick={handleClearFilter} className="bg-slate-500 hover:bg-slate-600 text-white px-2.5 py-1 rounded-sm inline-flex items-center">
                ...
                <div className="flex items-center justify-end mb-4 md:px-0 md:pr-0.5 px-0.5 pt-2 text-xs"> 
                    <Flatpickr
                        ...
                        placeholder="From"
                        className="bg-transparent text-xs md:text-sm border border-slate-300 text-slate-700 dark:text-white py-1 md:py-0.5 rounded-sm w-full md:w-auto"
                    />
                    {/* <label
                      htmlFor="deathc_date"
                    ...
                    <Flatpickr
                              ...
                              className="bg-transparent text-xs md:text-sm border border-slate-300 text-slate-700 dark:text-white py-1 md:py-0.5 rounded-sm w-full md:w-auto"
                          />
                        <button id="dropdownDefaultButton"  onClick={handleClearFilter} className="bg-slate-500 hover:bg-slate-600 text-white ml-2 px-2.5 py-1 rounded-sm inline-flex items-center"
                          >
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
