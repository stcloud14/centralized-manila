              ...
              {isSuccess && (
                ...
                {warning && (
                    ...
                    <div className="grid-cols-3 grid gap-6">
                      ...
                      <div class="relative z-0 w-full mb-6 group col-span-1">
                        <button 
                          ...
                          type="button" 
                          className="w-full text-blue-500 hover:text-white border border-blue-500 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-normal rounded-sm text-sm px-4 py-2.5 text-center ml-0 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">
                          Generate
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-end items-end mt-10 mb-4">
                    <button onClick={handleSubmit} type="submit" className="text-blue-500 hover:text-white border border-blue-500 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-normal rounded-sm text-sm px-10 py-2.5 text-center mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">
                         + Add Admin
                    </button>
                  </div>
         {/* PROCESS MODAL */}
